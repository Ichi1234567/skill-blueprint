...
install_global() {
    ...
    ln -sf "$SCRIPT_DIR/blueprint-suspend.md" "$TARGET_DIR/blueprint-suspend.md"
    ln -sf "$SCRIPT_DIR/blueprint-resume.md" "$TARGET_DIR/blueprint-resume.md"
    ln -sf "$SCRIPT_DIR/blueprint-abandon.md" "$TARGET_DIR/blueprint-abandon.md"
    ...
    echo "  ~/.claude/commands/blueprint-suspend.md -> $SCRIPT_DIR/blueprint-suspend.md"
    echo "  ~/.claude/commands/blueprint-resume.md -> $SCRIPT_DIR/blueprint-resume.md"
    echo "  ~/.claude/commands/blueprint-abandon.md -> $SCRIPT_DIR/blueprint-abandon.md"
    echo ""
...
install_local() {
    ...
    echo "  $TARGET_DIR/blueprint-suspend.md -> $SCRIPT_DIR/blueprint-suspend.md"
    echo "  $TARGET_DIR/blueprint-resume.md -> $SCRIPT_DIR/blueprint-resume.md"
    echo "  $TARGET_DIR/blueprint-abandon.md -> $SCRIPT_DIR/blueprint-abandon.md"
    echo ""
